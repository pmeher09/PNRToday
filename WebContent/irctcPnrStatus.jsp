...
<html>
<head>
<title>IRCTC PNR Status | PNR Today</title>
...
<meta name="keywords"
	content="irctc pnr status, irctc, PNR, rail pnr status, train pnr status,pnr today">
...
<b>RELEASEDTicket :</b> Not Cancelled but Alternative Accommodation Provided
		...
		<form name="form" action="getPnrStatus " method="post">
			<div style="text-align: center; width: 85%; padding: 50px; font-size: 17px; color: #777;">PNR status of your
				Indian Railways or IRCTC booking can be checked online easily! Enter
				the <b>10-digit PNR (Passenger Name Record) </b>number and click on the
				<b>CHECK NOW!</b> button. You will find the PNR number on the top
				left corner of the ticket. Passengers can check the status of
				reservations on the various zones like Northern Railway, Central
				Railway, Southern Railway etc using this interface.</div>
			<div style="float: left; width: 45%;">
				<div id="pnrstatusbox_left" class="gradient1">
					<h1>IRCTC PNR STATUS</h1>
					<br /> <input type="number" id="pnrNumber" name="pnrNumber"
						required="required" class="textbox"
						placeholder="10 digit PNR Number"> <input type="submit"
						value="CHECK NOW !" onclick="return validate();" class="button">
					<br />
					<script async
				...
				<br /> <br />
				<div style="text-align: center; width: 550px; margin-left: 20px;">
