...
<meta name="description" content="PNR Status" />
<meta name="keywords"
	content="pnrstatus, pnr status, irctc, PNR, rail pnr status, train pnr status,pnr today">
...
<b>RELEASEDTicket :</b> Not Cancelled but Alternative Accommodation Provided
		...
		<form name="form" action="getPnrStatus " method="post">
			...
			<br /> <br />
			<div style="text-align: center; width: 740px; margin: auto;">
			...
			<div id="extracontent1">
				<div style="float: left;">
					<p id="question-home">Check PNR status through SMS</p>
					<p id="answer-home">You can also check PNR status of your
						ticket through mobile by sending SMS to any of these following
						numbers.</p>

					<p id="answer-home">PNR &lt;10-digit PNR number&gt; to 139</p>
					<p id="answer-home">PNR &lt;10-digit PNR number&gt; to 5676747</p>
					<p id="answer-home">PNR &lt;10-digit PNR number&gt; to 54959</p>
					<p id="answer-home">IRPNR &lt;10-digit PNR number&gt; to 57886</p>
					<br />
					<br />
					<p id="question-home">Check PNR Status Through Call</p>
					<p id="answer-home">Dial 139 from your landline or mobile
						number and follow the instructions.</p>
				</div>
				<div style="clear: both;"></div>
			</div>
			<div id="extracontent2">
				<div style="float: left;">
					<p id="question-home">Book tickets Online:</p>
					<p id="answer-home">
						Book ticket on-line from IRCTC official site <a
							href="http://www.irctc.gov.in" target="_blank">www.irctc.gov.in</a>
					</p>
					<br />

					<p id="question-home">TATKAL TICKETS:</p>
					<p id="answer-home">
						Book tatkal ticket on-line from IRCTC official site <a
							href="http://www.irctc.gov.in" target="_blank">www.irctc.gov.in</a>
					</p>
					<br />
					<p id="answer-home">
						Tatkal ticket booking opens at 10 AM one day before from train
						originating station. However, the day of journey is defined as the
						day of chart preparation. So if the train starts e.g. on 3rd, and
						reaches the desired boarding station on 4th. during the actual
						journey. <br /> 10AM is booking start time for AC seat. <br />
						11AM is start time for SLEEPER seat.<br /> <br /> Read more
						about tatkal scheme here:<br /> <a
							href="http://www.indianrail.gov.in/tatkal_Scheme.html"
							target="_blank">http://www.indianrail.gov.in/tatkal_Scheme.html</a>
					</p>
				</div>
				<div style="clear: both;"></div>
			</div>
